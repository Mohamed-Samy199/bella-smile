...
export default function ManagementTab({ patient }) {
  ...
  const formik = useFormik({
    initialValues: {
      ...
      noteIdoneita:    mgmt.noteIdoneita    || "",
  ...
  return (
    <form onSubmit={formik.handleSubmit} className="space-y-5">
      ...
      <FormField label="Suitability Notes">
        <textarea name="noteIdoneita"
          value={formik.values.noteIdoneita}
          onChange={formik.handleChange}
          rows={3}
          className="w-full border border-gray-300 rounded-xl px-4 py-2.5
                     text-sm text-gray-700 focus:outline-none
      ...
      <SubmitButton isPending={isPending}
        label="Save Management" pendingLabel="Saving..." />
