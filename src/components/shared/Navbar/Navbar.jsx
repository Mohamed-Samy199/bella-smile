...
const Navbar = ({ isTransparent }) => {
  ...
  return (
    <nav className={`fixed w-full z-[100] transition-all duration-500
      ${isTransparent ? 'bg-transparent py-5' : 'bg-white shadow-md py-3 shadow-blue-900/5'}`}>
      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-12">
        <div className="flex justify-between items-center">
          ...
          <Link to="/" className="flex items-center group cursor-pointer">
            <img src={logo} alt="Bella Smile Logo"
          ...
          <div className="hidden md:flex items-center space-x-10">
            <NavLink to="/"
              ...
              Home
              <span className="absolute -bottom-1 left-0 w-0 h-0.5 bg-mainColor
          ...
          <div className="hidden md:flex items-center gap-3">
            {user ? (
              <button
                ...
                } px-8 py-3 rounded-full font-bold hover:opacity-90
          ...
          <div className="md:hidden">
            <button
              ...
              className={`${isTransparent ? 'text-white' : 'text-darkColor'}
                          p-2 rounded-lg`}
            >
              {isMenuOpen
      ...
      {/* Mobile Menu */}
      <div className={`md:hidden absolute w-full bg-white border-b pt-20
                       -z-10 border-gray-100 transition-all duration-300
                       ease-in-out
        ${isMenuOpen
        ...
        <div className="px-6 py-8 space-y-6 shadow-2xl">
          ...
          <Link to="/" className="block text-xl font-bold text-darkColor">
            Home
          </Link>
          ...
          {user ? (
            <button
              onClick={logout}
              className="w-full bg-darkColor text-white py-4 rounded-2xl
            ...
            <div className="space-y-3">
              ...
              <Link to="/register" className="block">
                <button className="w-full border border-darkColor
                                   text-darkColor py-4 rounded-2xl font-bold
              ...
              <Link to="/login" className="block">
                <button className="w-full bg-darkColor text-white py-4
                                   rounded-2xl font-bold flex items-center
                                   justify-center gap-3 shadow-xl">
                  <User size={22} />
                  Login
                </button>
              </Link>
